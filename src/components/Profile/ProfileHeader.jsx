import { Flex, Avatar, AvatarGroup, Button, Text, VStack } from "@chakra-ui/react"

const ProfileHeader = () => {
  return (
    <Flex gap={{ base: 4, sm: 10 }} py={10} direction={{ base: "column", sm: "row" }}>
      <AvatarGroup size={{ base: "xl", sm: "2xl" }} justifyContent={"center"} alignSelf={"flex-start"} mx={"auto"}>
